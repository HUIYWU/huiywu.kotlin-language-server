...
class StructuralIncompleteExpressionCapabilitySmokeTest : SingleFileTestFixture("diagnosticStructural", "IncompleteExpression.kt") {
    @Test fun `open incomplete expression file publishes at least one non-empty diagnostics batch`() {
