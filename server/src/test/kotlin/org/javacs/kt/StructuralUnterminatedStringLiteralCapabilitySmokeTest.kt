...
class StructuralUnterminatedStringLiteralCapabilitySmokeTest : SingleFileTestFixture("diagnosticStructural", "UnterminatedStringLiteral.kt") {
    @Test fun `open unterminated string literal file publishes at least one non-empty diagnostics batch`() {
