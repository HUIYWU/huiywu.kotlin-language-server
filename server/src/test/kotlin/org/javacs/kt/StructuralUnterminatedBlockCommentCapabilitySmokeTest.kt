...
class StructuralUnterminatedBlockCommentCapabilitySmokeTest : SingleFileTestFixture("diagnosticStructural", "UnterminatedBlockComment.kt") {
    @Test fun `open unterminated block comment file publishes at least one non-empty diagnostics batch`() {
