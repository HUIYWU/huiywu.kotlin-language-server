...
class StructuralUnterminatedCharLiteralCapabilitySmokeTest : SingleFileTestFixture("diagnosticStructural", "UnterminatedCharLiteral.kt") {
    @Test fun `open unterminated char literal file publishes at least one non-empty diagnostics batch`() {
